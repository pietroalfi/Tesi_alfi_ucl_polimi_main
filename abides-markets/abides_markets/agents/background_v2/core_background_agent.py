...
class CoreBackgroundAgent(TradingAgent):
    def __init__(
        ...
        self.episode_executed_orders: Deque[List[Order]] = deque(maxlen=20)  # list of executed orders during full episode
    ...
    def get_parsed_volume_data(self, message: TransactedVolDataMsg) -> Dict[str, Any]:
        ...
        bid_volume_per_level = message.bid_volume_per_level
        ask_volume_per_level = message.ask_volume_per_level
        ...
        volume_data = {
            ...
            "bid_volume_per_level" : bid_volume_per_level,
            "ask_volume_per_level" : ask_volume_per_level
        }
        return volume_data
    ...
    def get_internal_data(self) -> Dict[str, Any]:
        ...
        self.order_status = dict(list(self.order_status.items())[-50:])
