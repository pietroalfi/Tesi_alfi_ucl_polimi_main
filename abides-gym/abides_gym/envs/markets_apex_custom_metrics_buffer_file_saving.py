...
class MyCallbacks(DefaultCallbacks):
    # external file saved step by step 
    REPLAY_BUFFER_PATH = "/g100/home/userexternal/palfi000/ray_results/replay_buffer.pkl"
    ...
    def on_checkpoint_restore(self, *, trainer, checkpoint_dir, **kwargs):
        try:
            if os.path.exists(self.REPLAY_BUFFER_PATH):
                ...
                print(f"[External] Replay buffer restored from {self.REPLAY_BUFFER_PATH}")
            else:
                print(f"Replay buffer file not found at {self.REPLAY_BUFFER_PATH}")
        except Exception as e:
            print(f"Error restoring replay buffer: {e}")
    ...
    def on_train_result(self, *, trainer, result: dict, **kwargs):
        ...
        try:
            ...
            print(f"[External] Replay buffer saved to {self.REPLAY_BUFFER_PATH}")
        except Exception as e:
