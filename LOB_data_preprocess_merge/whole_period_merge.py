...
def merge_pickle_files(input_dir, output_file_pkl, output_file_parquet):
    ...
    # Assicuriamoci che l'indice abbia il nome "Date" e la Series il nome "mid_price"
    merged.index.name = "Date"
    merged.name = "mid_price"
...
if __name__ == "__main__":
    ...
    input_directory = "/g100/home/userexternal/palfi000/ucl-thesis-main/LOB_data_preprocess_merge/Filtered_data"
    # Definisci i nomi dei file di output
    output_pickle_file = os.path.join(input_directory, "INTC_merged_mid_price.pkl")
    output_parquet_file = os.path.join(input_directory, "INTC_merged_mid_price.parquet")
